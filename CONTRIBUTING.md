...
- **Contributor guide**: see
  [docs/development/contributing.md](docs/development/contributing.md) for the
  branch workflow, commit style, and PR checklist.
- **Development setup**: see
  [docs/development/local-dev.md](docs/development/local-dev.md) for toolchain
