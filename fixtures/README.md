...
| `mcnp/` | 36 | 473,426 bytes | mcnp — MCNP input decks, tallies, and binary-format oracles |
| `mcpl/` | 15 | 7,960 bytes | mcpl — Synthetic MCPL interchange fixtures authored for Nucleide (no license needed) |
